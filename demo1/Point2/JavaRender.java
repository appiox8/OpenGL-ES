...
public class JavaRender implements GLSurfaceView.Renderer{
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        GLES20.glVertexAttrib3f(pointPositionHandle, 0.0f, 0.0f, 0.0f);
        // Since we are not using a buffer object, disable vertex arrays for this attribute.
        GLES20.glDisableVertexAttribArray(pointPositionHandle);

        GLES20.glVertexAttrib4f(pointColorHandle, 1.0f, 0.0f, 0.0f, 1.0f);
        ...
        GLES20.glVertexAttrib4f(pointColorHandle, 0.0f, 1.0f, 0.0f, 1.0f);
        GLES20.glDisableVertexAttribArray(pointColorHandle);

        // Pass in the transformation matrix.
        Matrix.setIdentityM(mModelMatrix, 0);
        Matrix.translateM(mModelMatrix, 0, 3.0f, 0.0f, 0.0f);
        Matrix.multiplyMM(mMVPMatrix, 0, mViewMatrix, 0, mModelMatrix, 0);
        Matrix.multiplyMM(mMVPMatrix, 0, mProjectionMatrix, 0, mMVPMatrix, 0);
        GLES20.glUniformMatrix4fv(pointMVPMatrixHandle, 1, false, mMVPMatrix, 0);
        ...
        GLES20.glVertexAttrib4f(pointColorHandle, 0.0f, 0.0f, 1.0f, 1.0f);
        GLES20.glDisableVertexAttribArray(pointColorHandle);
        ...
        GLES20.glVertexAttrib4f(pointColorHandle, 0.0f, 1.0f, 1.0f, 1.0f);
        GLES20.glDisableVertexAttribArray(pointColorHandle);
